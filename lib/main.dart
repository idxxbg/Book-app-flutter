...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Flutter Book App'),
    );
  }
}
...
//           ),
//         ),
//         heroImage: Image.asset('assets/images/book 4.jpg'),
//         pageTitle: Padding(
//           padding: const EdgeInsets.all(8.0),
//           child: Text("Always For The First Time", style: textTheme.titleLarge),
//         ),
